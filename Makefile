...
SOURCES = libnormaliz.cpp full_cone.cpp integer.cpp cone_dual_mode.cpp lineare_transformation.cpp list_operations.cpp matrix.cpp mode.cpp Normaliz.cpp output.cpp simplex.cpp sublattice_representation.cpp vector_operations.cpp
...
normbig: Normaliz.cpp $(NBIGOBJ)
	$(CXX) $(CXXFLAGS) $(NBIGFLAGS) Normaliz.cpp $(GMPFLAGS) -o normbig
