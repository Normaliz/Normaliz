...
Main computation goals and algorithmic variants allowed are:
\begin{center}
\texttt{
\begin{tabular}{llll}
...
Triangulation&  ProjectCone & ConeDecomposition &  TriangulationDetSum\\
...
SingleLatticePoint& FusionRings & SimpleFusionRings & SingleFusionRings\\
SuppHypsFloat
\end{tabular}	}
\end{center}
...
\verb|Volume| is restricted to full-dimensional polytopes. In the homogeneous case the grading must have integer coprime coefficients. Implicit or explicit \verb|DefaultMode| is interpreted as \verb|SupportHyperplanes|.

Volumes are computed by triangulation and lattice points by project-and-lift.

Look up \verb*|cone_properties.cpp|, function \verb*|all_Q_permissible()| for the full list of computation goals and algorithmic variants that are allowed for computations with field coefficients. 
