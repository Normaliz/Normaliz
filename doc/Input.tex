...
\end{itemize}
converts equations into pairs of inequalities and has almost the same effect, but congruences in the input trigger the coordinate transformation nevertheless. Requires the addition of \verb|nonnegative| if no other inequalities are present.
