...
\begin{itemize}
	...
	\itemtt[convert\_equations] converts equations in the input file into inequalities. Can be useful to avoid superfluous coorddinate transformations. May require the addiion of \verb|nonnegative|. \example{pet.in}
