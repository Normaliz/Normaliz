...
\begin{itemize}
	...
	\itemtt[convert\_equations] converts equations in the input file into inequalities. Can be useful to avoid superfluous coorddinate transformations. Require the addiion of \verb|nonnegative| if no other inequalities are present. \example{pet}
...
\begin{itemize}
	...
	\itemtt[UseWeightsPatching] mkwa Normaliz use ''weights of cordinates'' in scheduling the patching algorithm in the presence of polynomail equations.
	\itemtt[ChamgePatchingOrder] toggles between different orders in scheduling the patching algorithm.
	\bigskip
