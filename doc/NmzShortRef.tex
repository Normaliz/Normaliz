...
\begin{itemize}
	...
	\itemtt[lattice\_ideal] is a matrix with $d$ columns containing the generators of a lattice ideal $L$ in the Laurent polynomial ring. It defines the intersection of $L$ with the polynomial ring.
	
	\itemtt[toric\_ideal] is a matrix with $d$ columns containing the generators of a lattice ideal in the Laurent polynomial ring. It defines the smallest toric ideal $T$ in the polynomial ring contaioning the generators and the affine monoid underlying the quotient of the polynomial ring modulo $T$.
	
	\itemtt[normal\_toric\_ideal] is a matrix with $d$ columns containing the generators of a lattice ideal in the Laurent polynomial ring. It It goes one step further than \verb|toric_ideal| by passing further to the normalizaion of the affime monoid.
...
\begin{itemize}
	\itemtt[MarkovBasis] computes a dsystem of generators of a givemn lattice or toric ideal defining an affine monoid.
	
	\itemtt[GroebnerBasis] computes a Gröbner basis of a lttice or toric ideal.
\end{itemize}
...
\begin{itemize}
	...
	\itemtt[IsSerreR1] checks whether a mo noid alebra satisfies the Serre condition $(R_1)$.\medskip
...
\begin{itemize}
	...
	\itemtt[ogn] contains the refernce generators for Markov bases, Gröbner bases and represntations, unless given by the Hilbert basis.
...
\begin{itemize}
	...
	\itemtt[BinomialsPacked] chooses a packed format for \ttt{mrk}, \ttt{grb} and \ttt{rep}.
