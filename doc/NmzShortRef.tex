...
If there are no cone generators or inequalities, Normaliz automatically assumes the sign inequalities defining the positive orthant positive orthant. This behavior can be broken by an empty matrix \verb|inequalities 0| or by the directive
\begin{itemize}
...
\begin{itemize}
	...
	\itemtt[NoLLL] blocks the use of LLL.
	...
	\itemtt[Patching] forces the patching variant of project-and-lift whenever possible.
