...
\begin{itemize}
	...
	\itemtt [WitnessNotIntegrallyClosed, -w] Normaliz stops the Hilbert basis computation as soon it has found a witness confirming that the original monoid is not integrally closed.\bigskip
