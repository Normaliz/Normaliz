...
\begin{itemize}
	...
	\itemtt[convert\_equations] converts equations in the input file into inequalities. Can be useful to avoid superfluous coorddinate transformations. Require the addiion of \verb|nonnegative| if no other inequalities are present. \example{pet.in}
...
\end{itemize}
where \verb|<n>| is the number of polynomials that follow. Everey polynomial must be concuded by a semicolon. \example{pet.in}
...
\begin{arab}
	\item certain computations based on the dual algorithm;
	\item \verb|Projection| or \verb|ProjectionFloat| applied to parallelotopes;
...
\begin{itemize}
	...
	\itemtt[NoSymmetrization, -X] blocks symmetrization.\bigskip
