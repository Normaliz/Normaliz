...
case $BUILDSYSTEM in
    ...
    *static*)
        if [[ $OSTYPE == darwin* ]]; then
            ...
            install -m 0644 $(brew --prefix)/lib/libomp.dylib ${PREFIX}/bin
            ...
            install_name_tool -change "$(brew --prefix)/lib/libomp.dylib" "@loader_path/./libomp.dylib" ${PREFIX}/bin/normaliz
        fi
