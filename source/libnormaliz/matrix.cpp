...
template<typename Integer>
void Matrix<Integer>::LLL_transform(Matrix<Integer>& Lred, Matrix<Integer>& T, Matrix<Integer>& Tinv){
...
template<typename Integer>
void Matrix<Integer>::LLL_transform_transpose(Matrix<Integer>& Lred, Matrix<Integer>& T, Matrix<Integer>& Tinv){
