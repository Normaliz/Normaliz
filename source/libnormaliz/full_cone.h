...
class Full_Cone {
   ...
   public:
    ...
    bool do_h_vector;
    bool export_triangulation;  // to calling cone
    bool store_simplices; // true as long as simplices m,ust be stored
    ...
    list<SimplexEvaluator<Integer>> LargeSimplicesBuffer;            // temporyry storage
